...
#pragma once
#ifndef OMEDIA_GLCanvas_H
#define OMEDIA_GLCanvas_H
...
class OMediaGLCanvas : public OMediaCanvasSlave
{
	public:
	
	omtshared OMediaGLCanvas(OMediaGLRenderTarget *target, 
							 OMediaCanvas *master,
							 omt_CanvasSlaveKeyFlags key_flags);

	omtshared virtual ~OMediaGLCanvas();
	...
	GLuint find_internal_format(omt_PixelFormat);

	GLuint					texture_id,internal_format;
	GLuint					*texturegrid_id;
