...
#pragma once
#ifndef OMEDIA_3DMorphAnimFrame_H
#define OMEDIA_3DMorphAnimFrame_H
...
class OMedia3DMorphAnimFrame : public OMediaAnimFrame
{
	...
	omtshared OMedia3DMorphAnimFrame();
	omtshared virtual ~OMedia3DMorphAnimFrame();
